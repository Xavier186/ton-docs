...
> A **full tutorial** covering everything from [configuring your environment](https://about/bots/tutorial#getting-ready) to [deploying](https://about/bots/tutorial#hosting) your finished bot is available here.
...
* **Nutgram**. The Telegram bot framework that doesn't drive you nuts.\
  [https://github.com/nutgram/nutgram](https://github.com/nutgram/nutgram)
* **Telegraph**. A Laravel package for fluently interacting with Telegram Bots.\
  [https://github.com/def-studio/telegraph](https://github.com/def-studio/telegraph)
* **tgWebValid**. Library for Telegram Web App User Validation and Telegram Login Widget for PHP.\
  [https://github.com/CrazyTapok-bit/tgWebValid](https://github.com/CrazyTapok-bit/tgWebValid)
* **BPT**. A simple library for working with Telegram Api.\
  [https://github.com/BPTproto/BPT](https://github.com/BPTproto/BPT)\
  [https://github.com/BPTproto/BPT-Multi](https://github.com/BPTproto/BPT-Multi)
* **LaraGram**. An advanced framework for Telegram Bot development.\
  [https://github.com/laraXgram/LaraGram](https://github.com/laraXgram/LaraGram)
* **BotAPI**. SDK for the Telegram Bot API.\
  [https://github.com/TelegramSDK/BotAPI](https://github.com/TelegramSDK/BotAPI)
* **TuriBot**. A simple way to communicate with Telegram APIs in PHP.\
  [https://github.com/davtur19/TuriBot](https://github.com/davtur19/TuriBot)
* **TelegramBotsApi**. SDK for Telegram Bot API.\
  [https://github.com/kuvardin/TelegramBotsApi](https://github.com/kuvardin/TelegramBotsApi)
...
* **Telegram Bot PHP**. A library that makes using Telegram Bot API much easier.\
  [https://github.com/telegram-bot-php/core](https://github.com/telegram-bot-php/core)
...
* **Bot API PHP SDK**. Telegram Bot API PHP SDK. Supports Laravel out of the box.\
  [https://github.com/irazasyed/telegram-bot-sdk](https://github.com/irazasyed/telegram-bot-sdk)
* **klev-o/telegram-bot-api**. Simple and convenient object-oriented implementation Telegram Bot API with PHP version ^7.4 support.\
  [https://github.com/klev-o/telegram-bot-api](https://github.com/klev-o/telegram-bot-api)
* **TeleBot**. Easy way to create Telegram bots in PHP. Rich Laravel support out of the box.\
  [https://github.com/westacks/telebot](https://github.com/westacks/telebot)
* **TgBotLib**. Telegram Bot Library for ncc.\
  [https://github.com/nosial/TgBotLib](https://github.com/nosial/TgBotLib)
* **NeleBot X Framework**. Framework for Telegram Bot API.\
  [https://github.com/NeleB54Gold/NeleBotX](https://github.com/NeleB54Gold/NeleBotX)
* **PHP Telegram Bot Api**. Native PHP Wrapper for Telegram BOT API.\
  [https://github.com/TelegramBot/Api](https://github.com/TelegramBot/Api)
...
* **Telego**. Telegram Bot API library.\
  [https://github.com/mymmrac/telego](https://github.com/mymmrac/telego)
...
* **go-tg**. Library for accessing Telegram Bot API, with batteries for building complex bots included.\
  [https://github.com/mr-linch/go-tg](https://github.com/mr-linch/go-tg)
* **Telegram Bot API: Go implementation**. A Telegram IM bots API implementation.\
  [https://github.com/temoon/telegram-bots-api](https://github.com/temoon/telegram-bots-api)
...
* **Telegram Bot API helper for Golang**. A Telegram Bot API wrapper.\
  [https://github.com/meinside/telegram-bot-go](https://github.com/meinside/telegram-bot-go)
...
* **Telegrambot**. Telegram Bot API in Go, but with more clean code.\
  [https://github.com/nickname76/telegrambot](https://github.com/nickname76/telegrambot)
...
* **telegram-text**. A Python markup module, which can be used with other frameworks.\
  [https://github.com/SKY-ALIN/telegram-text](https://github.com/SKY-ALIN/telegram-text)
* **TGramBot**. A partially auto-generated and asynchronous Minimal Telegram Bot API framework.\
  [https://github.com/KeralaBots/TGramBot](https://github.com/KeralaBots/TGramBot)
* **OrigamiBot**. A pythonic Telegram bot API library.\
  [https://github.com/cmd410/OrigamiBot](https://github.com/cmd410/OrigamiBot)

**Rust**

* **Frankenstein**. A Telegram Bot API client.\
  [https://github.com/ayrat555/frankenstein](https://github.com/ayrat555/frankenstein)
...
* **Ferrisgram**. An asynchronous autogenerated wrapper for the Telegram Bot API.\
  [https://github.com/ferrisgram/ferrisgram](https://github.com/ferrisgram/ferrisgram)
* **tgbotapi**. A library for using the Telegram Bot API.\
  [https://github.com/Syfaro/tgbotapi-rs](https://github.com/Syfaro/tgbotapi-rs)
...
* **MOBOT**. A Telegram Bot Library in Rust.\
  [https://github.com/0xfe/mobot](https://github.com/0xfe/mobot)

**Kotlin**

* **TelegramBotAPI**. Type-safe library for work with Telegram Bot API.\
  [https://github.com/InsanusMokrassar/TelegramBotAPI](https://github.com/InsanusMokrassar/TelegramBotAPI)
* **Kotlin Telegram Bot**. Telegram Bot API wrapper, with handy Kotlin DSL.\
  [https://github.com/vendelieu/telegram-bot](https://github.com/vendelieu/telegram-bot)
* **Kotlin Telegram Bot**. A wrapper for the Telegram Bot API.\
  [https://github.com/kotlin-telegram-bot/kotlin-telegram-bot](https://github.com/kotlin-telegram-bot/kotlin-telegram-bot)
* **kt-telegram-bot**. Telegram Bot API library for Kotlin language.\
  [https://github.com/elbekD/kt-telegram-bot](https://github.com/elbekD/kt-telegram-bot)

**.NET**

* **Telegram.bot**. .NET Client for Telegram Bot API.\
  [https://github.com/TelegramBots/Telegram.Bot](https://github.com/TelegramBots/Telegram.Bot)
* **RxTelegram.Bot**. RxTelegram uses a reactive approach to make Updates available.\
  [https://github.com/RxTelegram/RxTelegram.Bot](https://github.com/RxTelegram/RxTelegram.Bot)
* **Telegram.BotAPI for NET**. One of the most complete libraries available to interact with the Telegram Bot API.\
  [https://github.com/Eptagone/Telegram.BotAPI](https://github.com/Eptagone/Telegram.BotAPI)
* **Telegram.Bots**. A .NET 5 wrapper for the Telegram Bot API.\
  [https://github.com/TelegramBotsAPI/Telegram.Bots](https://github.com/TelegramBotsAPI/Telegram.Bots)

**C++**

* **QTelegramBotAPI**. Telegram Bot API on C++ and Qt.\
  [https://github.com/Modersi/TelegramBotAPI](https://github.com/Modersi/TelegramBotAPI)
* **tgbot**. A library for Telegram Bot API with generated API types and methods.\
  [https://github.com/egorpugin/tgbot](https://github.com/egorpugin/tgbot)
...
* **Telegram::Bot**. Ruby gem for building Telegram Bot with optional Rails integration.\
  [https://github.com/telegram-bot-rb/telegram-bot](https://github.com/telegram-bot-rb/telegram-bot)
* **TelegramWorkflow**. A simple utility to help you organize the code to create Telegram bots.\
  [https://github.com/rsamoilov/telegram\_workflow](https://github.com/rsamoilov/telegram\_workflow)
...
* **Telenode**. Lightweight Telegram API framework for Node.js.\
  [https://github.com/NivEz/telenode](https://github.com/NivEz/telenode)
...
* **grammY**. The Telegram Bot Framework.\
  [https://github.com/grammyjs/grammY](https://github.com/grammyjs/grammY)
* **puregram**. Powerful and modern telegram bot api sdk for node.js and typescript.\
  [https://github.com/nitreojs/puregram](https://github.com/nitreojs/puregram)
...
* **Java API**. Telegram Bot API for Java.\
  [https://github.com/pengrad/java-telegram-bot-api](https://github.com/pengrad/java-telegram-bot-api)

**Scala**

* **bot4s.telegram**. Simple, extensible, strongly-typed wrapper for the Telegram Bot API.\
  [https://github.com/bot4s/telegram](https://github.com/bot4s/telegram)
* **F\[Tg] - Telegramium**. Pure functional Telegram Bot API implementation.\
  [https://github.com/apimorphism/telegramium](https://github.com/apimorphism/telegramium)

**Lua**

* **ggram**. Lua library for the Telegram bot API. You can even use it in Garry's Mod.\
  [https://github.com/TRIGONIM/ggram](https://github.com/TRIGONIM/ggram)
* **telegram-bot-lua**. A feature-filled Telegram Bot API library.\
  [https://github.com/wrxck/telegram-bot-lua](https://github.com/wrxck/telegram-bot-lua)

**Other Languages**

* Swift. **Telegram Vapor Bot**. The wrapper for the Telegram Bot API written in Swift with Vapor.\
  [https://github.com/nerzh/telegram-vapor-bot](https://github.com/nerzh/telegram-vapor-bot)
* Elixir. **ExGram**. Telegram Bot API low level API and framework.\
  [https://github.com/rockneurotiko/ex\_gram](https://github.com/rockneurotiko/ex\_gram)
* Dart. **TeleDart**. A library interfacing with the latest Telegram Bot API.\
  [https://github.com/DinoLeung/TeleDart](https://github.com/DinoLeung/TeleDart)
* Pascal. **TGBotMini**. Telegram Bot Mini API.\
  [https://github.com/HemulGM/TGBotMini](https://github.com/HemulGM/TGBotMini)
* Clojure. **telegrambot-lib**. A library for interacting with the Telegram Bot API.\
  [https://github.com/wdhowe/telegrambot-lib](https://github.com/wdhowe/telegrambot-lib)
...
* Haskell. **haskell-telegram-api**. High-level bindings to the Telegram Bot API based on [servant](https://haskell-servant.github.io/) library.\
  [https://github.com/klappvisor/haskell-telegram-api](https://github.com/klappvisor/haskell-telegram-api)
* Perl. **Telegram Bot**. A genuine Perl 6 client for the Telegram's Bot API.\
  [https://github.com/GildedHonour/TelegramBot](https://github.com/GildedHonour/TelegramBot)
